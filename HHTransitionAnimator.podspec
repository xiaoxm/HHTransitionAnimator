...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HHTransitionAnimator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/786696937@qq.com/HHTransitionAnimator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '786696937@qq.com' => 'herui@ifensi.com' }
  s.source           = { :git => 'https://github.com/786696937@qq.com/HHTransitionAnimator.git', :tag => s.version.to_s }
